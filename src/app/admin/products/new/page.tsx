    ...
    <div style={{maxWidth:1100}}>
      ...
      <div className="wp-card"><h2>Add New Product</h2>
        <form onSubmit={submit}>
          ...
          {f('Images',<textarea rows={3} value={form.images} onChange={e=>setForm({...form,images:e.target.value})} placeholder="Paste image URLs, one per line" style={{marginBottom:8}} />)}
